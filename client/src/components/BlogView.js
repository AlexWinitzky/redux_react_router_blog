  ...
  render() {
    ...
    return (
      <Container>
        ...
        <Link style={{margin: '5px'}} to="/blogs">View All Posts</Link>
        <Button style={{margin: '5px'}} color="blue" onClick={this.toggleForm}>
          { showForm ? "Cancel" : "Edit" }
        </Button>
        <Button style={{margin: '5px', marginBottom: '20px'}} color="red" onClick={this.handleDelete}>
          Delete
        </Button>
        </div>
        {
